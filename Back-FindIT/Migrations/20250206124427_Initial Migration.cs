        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_Users_ClaimedBy",
                        column: x => x.ClaimedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Items_Users_RegisteredBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ItemDescription = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ItemCreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ItemUpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ItemIsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ItemCategoryId = table.Column<int>(type: "int", nullable: false),
                    ItemRegisteredBy = table.Column<int>(type: "int", nullable: false),
                    ItemClaimedBy = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.ComputedColumn)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ClaimedBy",
                table: "Items",
                column: "ClaimedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Items_RegisteredBy",
                table: "Items",
                column: "RegisteredBy");
